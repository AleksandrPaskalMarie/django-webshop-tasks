...
urlpatterns = [
    ...
    path('manufacturers/add/', views.ManufacturerCreateView.as_view(), name='manufacturer_create_page'),
    path('manufacturers/add/success/', views.ManufacturerCreatedSuccessView.as_view(), name='manufacturer_created_success_page'),
    ...
    path('manufacturers/stats/', views.ManufacturerStatsListView.as_view(), name='manufacturer_stats'),
    ...
    path('newsletter/success/', TemplateView.as_view(template_name='webshop/newsletter_success.html'), name='newsletter_success'),
