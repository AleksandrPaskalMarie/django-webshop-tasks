...
SECRET_KEY = 'django-insecure-z=os0a82zu2k+piop%o%2ru9j_n36h7auy9dnf-8&5_yr6!mi4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # Это указывает на папку 'templates' в корне проекта
